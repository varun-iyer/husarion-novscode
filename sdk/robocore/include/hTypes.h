...
/**
 * @brief C++11 function handler with one argument
 */
typedef std::function<void(void*)> HandlerUserData;

/**
 * @brief C++11 function handler without arguments
 */
...
public:
	...
	AutoHandler() { }
	AutoHandler(const Handler& h1) : h1(h1), h2(nullptr) { }
	AutoHandler(const HandlerUserData& h2, void* userdata) : h1(nullptr), h2(h2), userdata(userdata) { }
};
