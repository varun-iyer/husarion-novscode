...
public:
	...
	virtual void interruptOn(InterruptEdge edge, CountingMode mode = CountingMode::Normal) { _interruptOn(edge, mode, AutoHandler()); }
	virtual void interruptOn(InterruptEdge edge, CountingMode mode, const Handler& handler) { _interruptOn(edge, mode, AutoHandler(handler)); }
	virtual void interruptOn(InterruptEdge edge, CountingMode mode, const HandlerUserData& handler, void* userdata) { _interruptOn(edge, mode, AutoHandler(handler, userdata)); }
	virtual void interruptOn(InterruptEdge edge, const Handler& handler) { _interruptOn(edge, CountingMode::Normal, AutoHandler(handler)); }
	virtual void interruptOn(InterruptEdge edge, const HandlerUserData& handler, void* userdata) { _interruptOn(edge, CountingMode::Normal, AutoHandler(handler, userdata)); }
	...
	void interruptOn_EdgeFalling(CountingMode mode, const Handler& handler) { interruptOn(InterruptEdge::Falling, mode, handler); }
	void interruptOn_EdgeFalling(CountingMode mode, const HandlerUserData& handler, void* userdata) { interruptOn(InterruptEdge::Falling, mode, handler, userdata); }
	...
	void interruptOn_EdgeRising(CountingMode mode, const Handler& handler) { interruptOn(InterruptEdge::Rising, mode, handler); }
	void interruptOn_EdgeRising(CountingMode mode, const HandlerUserData& handler, void* userdata) { interruptOn(InterruptEdge::Rising, mode, handler, userdata); }
	...
	void interruptOn_EdgeChange(CountingMode mode, const Handler& handler) { interruptOn(InterruptEdge::Both, mode, handler); }
	void interruptOn_EdgeChange(CountingMode mode, const HandlerUserData& handler, void* userdata) { interruptOn(InterruptEdge::Both, mode, handler, userdata); }
...
protected:
	virtual void _interruptOn(InterruptEdge edge, CountingMode mode, const AutoHandler& handler) = 0;
};
